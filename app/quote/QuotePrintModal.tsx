...
const OUR = {
  ...
  ceo: "조대성",
  address: "경기도 파주시 광탄면 장지산로 250-90. 1동",
  bizType: "제조업",
  bizItem: "식품제조가공업",
  phone: "02-356-3380",
  kakao: "cacaoplus",
  email: "bonusmate@naver.com",
                  ...
                  <td style={{ border: "none", verticalAlign: "top", width: "56%" }}>
                    ...
                    <table style={{ borderCollapse: "collapse", width: "100%", fontSize: 11 }}>
                      <tbody>
                        ...
                        {/* 카카오/이메일 */}
                        <tr>
                        <td style={{ border: "1px solid #999", background: "#f5f5f5", textAlign: "center", padding: "3px 4px", fontSize: 10, whiteSpace: "nowrap" }}>카카오톡 ID</td>
