...
export function calculateQuote(productKey, input) {
  ...
  const { width, height, quantity, isNew = false, moldQty = 1, useStockMold = false, reuseExistingMold = false, designChanged = false, sheetPerPage } = input
  if (sheetPerPage) p = { ...p, sheetFixed: sheetPerPage }
